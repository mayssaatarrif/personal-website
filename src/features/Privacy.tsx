...
const Privacy = () => {
  return (
    <div>
      <h2 className="text-2xl font-bold mb-4 mt-4 text-gray-900">Privacy Policy</h2>
      <hr className="border-t border-[#b2b355] my-4" />
      <div className="mt-8 font-light font-sans">
        <p className="mb-4">
        The Privacy Policy and terms described below is an integral part of Terms and Conditions 
        for the use of the personal website of H.H. Ruler of Sharjah www.sheikhdrsultan.ae and 
        its provisions.
        </p>
        <p className="mb-4">
        www.sheikhdrsultan.ae does not collect and store any personal information about individuals who
        access this website, except where that information is freely volunteered via e-mail, entries in the
        guest book. In these cases www.sheikhdrsultan.ae will never sell or 
        share your personal information with a third party.
        </p>
        <p className="mb-4">
        www.sheikhdrsultan.ae sends cookies from this website.
        These cookies are used only to determine the media player, and language selections of our visitors.
        </p>
        <p className="mb-4">
        All other information collected is anonymous, such as the domain name of your Internet Service Provider.
        </p>
        <p className="mb-4">
        If the privacy policy changes, these changes will be posted online in order to notify our users.
        </p>
      </div>
    </div>
  );
