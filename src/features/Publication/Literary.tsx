...
import literaryWorks from './LiteraryMock'; // Ensure this contains all literary works data
            ...
            <div className="text-sm breadcrumbs">
              <ul>
                <div className="flex space-x-1 mt-10">
                  ...
                  <li><a href="" className="text-[#bbbd4f]">Literary</a></li>
                </div>
              </ul>
            </div>
...
const Literary = () => {
  ...
  const booksPerPage = 8; // Set this to your desired books per page
  const totalPages = Math.ceil(literaryWorks.length / booksPerPage);

  const indexOfLastBook = currentPage * booksPerPage;
  const indexOfFirstBook = indexOfLastBook - booksPerPage;
  const currentBooks = literaryWorks.slice(indexOfFirstBook, indexOfLastBook);
  ...
  return (
    <div className="flex flex-col min-h-screen">
      ...
      <main className="flex-grow container mx-auto px-4 py-8">
        <Breadcrumb />
        <h1 className="text-4xl font-bold mb-8">Literary Works</h1>
        ...
        <div className="flex">
          ...
          <div className="w-1/4 pr-4">
            ...
            <ul>
              ...
              <li className="bg-[#bbbd4f] text-white p-2">Literary Works</li>
              <li className="bg-gray-200 p-2">Theatrical works</li>
            </ul>
            <div className="mt-8">
            <div className="mt-8">
              <InHisHighnessWords />
