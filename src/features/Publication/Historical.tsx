...
import historicalWorks from './HistoricalMock';
            ...
            <div className="text-sm breadcrumbs">
              <ul>
                <div className="flex space-x-1 mt-10">
                  ...
                  <li><a href="" className="text-[#bbbd4f]">Historical</a></li>
                </div>
              </ul>
            </div>
...
const Historical = () => {
  ...
  const totalPages = Math.ceil(historicalWorks.length / booksPerPage);

  const indexOfLastBook = currentPage * booksPerPage;
  const indexOfFirstBook = indexOfLastBook - booksPerPage;
  const currentBooks = historicalWorks.slice(indexOfFirstBook, indexOfLastBook);
  ...
  return (
    ...
    <div className="flex flex-col min-h-screen">
      ...
      <main className="flex-grow container mx-auto px-4 py-8">
        <Breadcrumb />
        <h1 className="text-4xl font-bold mb-8">Historical Works</h1>
        ...
        <div className="flex">
          ...
          <div className="w-1/4 pr-4">
            ...
            <ul>
              <li className="bg-[#bbbd4f] text-white p-2">Historical Works</li>
          ...
          {/* Current Books List and Components */}
